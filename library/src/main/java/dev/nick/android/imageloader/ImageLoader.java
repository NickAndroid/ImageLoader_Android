...
import dev.nick.android.imageloader.cache.BitmapCacheManager;
import dev.nick.android.imageloader.cache.CacheManager;
import dev.nick.android.imageloader.cache.MovieCacheManager;
import dev.nick.android.imageloader.control.Forkable;
import dev.nick.android.imageloader.control.Freezer;
import dev.nick.android.imageloader.control.LoaderState;
import dev.nick.android.imageloader.control.StorageStats;
import dev.nick.android.imageloader.control.TrafficStats;
import dev.nick.android.imageloader.queue.FIFOPriorityBlockingQueue;
import dev.nick.android.imageloader.queue.IdleStateMonitor;
import dev.nick.android.imageloader.queue.LIFOPriorityBlockingQueue;
import dev.nick.android.imageloader.queue.Priority;
import dev.nick.android.imageloader.queue.QueuePolicy;
import dev.nick.android.imageloader.queue.RequestHandler;
import dev.nick.android.imageloader.queue.RequestQueueManager;
import dev.nick.android.imageloader.scrollable.AbsListViewScrollDetector;
import dev.nick.android.imageloader.ui.DisplayOption;
import dev.nick.android.imageloader.ui.IDCreator;
import dev.nick.android.imageloader.ui.IDCreatorImpl;
...
import dev.nick.android.imageloader.worker.task.BaseFutureTask;
import dev.nick.android.imageloader.worker.task.BitmapDisplayTask;
import dev.nick.android.imageloader.worker.task.DisplayTaskRecord;
import dev.nick.android.imageloader.worker.task.FutureBitmapTask;
import dev.nick.android.imageloader.worker.task.FutureMovieTask;
import dev.nick.android.imageloader.worker.task.MokeFutureImageTask;
import dev.nick.android.imageloader.worker.task.MovieDisplayTask;
import dev.nick.android.imageloader.worker.task.TaskManager;
import dev.nick.android.imageloader.worker.task.TaskManagerImpl;
...
public class ImageLoader implements
    ...
    private ImageLoader(Context context, LoaderConfig config) {
        ...
        int loaderId = LoaderFactory.assignId();
    ...
    public void linkScrollStateTo(@NonNull RecyclerView view) {
        mLogger.verbose(view);
        synchronized (this) {
     ...
     */
    public ImageLoader cancel(@NonNull MediaHolder settable) {
