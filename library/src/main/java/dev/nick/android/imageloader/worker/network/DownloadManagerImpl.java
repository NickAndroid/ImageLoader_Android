...
package dev.nick.android.imageloader.worker.network;
...
import dev.nick.android.imageloader.cache.FileNameGenerator;
import dev.nick.android.imageloader.cache.KeyGenerator;
...
public class DownloadManagerImpl implements DownloadManager {
    ...
    public String endTransaction(final Transaction transaction) {
        ...
        if (exist) {
            ...
            long size = -1;
            try {
                size = Files.asByteSource(new File(result)).size();
